...
if(isset($_POST['btnsubmit']))
{
	...
	$sql="insert into a_registration(fname,phone_no,email,password)values('".$_POST['fname']."','".$_POST['phone_no']."','".$_POST['email']."','".$_POST['password']."')";
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 info" align="center">
					<h3><b></b></h3><br>
					<h1><b><i>Employee Management System</i></b> </h1>
					
              
				</div>
				<div class="col-sm-6 register" style="background-image: ">
